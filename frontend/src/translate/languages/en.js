    ...
    translations: {
      ...
      contactModal: {
        ...
        messageHandling: {
          ...
          note: "Choose how messages from this contact are handled.",
      ...
      backendErrors: {
        ...
        ERR_MSG_NOT_DELETABLE: "Could not delete the message for everyone. Only messages sent from this system and within WhatsApp's allowed window (approx. 48h) can be deleted.",
        ERR_MSG_NOT_EDITABLE: "Could not edit the message on WhatsApp. Only messages sent from this system within the last 15 minutes can be edited.",
