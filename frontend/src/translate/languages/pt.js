    ...
    translations: {
      ...
      contactModal: {
        ...
        messageHandling: {
          ...
          note: "Escolha como tratar as mensagens recebidas deste contato.",
          normal: "Normal (cria ticket como sempre)",
          silent: "Silenciar (guarda sem marcar como não lida)",
          ignore: "Ignorar (não cria ticket nem guarda a mensagem)",
          normalShort: "Normal",
          silentShort: "Silenciar",
          ignoreShort: "Ignorar",
          saved: "Preferência de mensagens salva."
        },
        buttons: {
      ...
      backendErrors: {
        ...
        ERR_FETCH_WAPP_MSG: "Erro ao buscar a mensagem no WhatsApp, talvez ela seja muito antiga.",          ERR_INVALID_CREDENTIALS: "Erro de autenticação. Por favor, tente novamente.",
          ERR_MSG_NOT_DELETABLE: "Não foi possível excluir a mensagem para todos. Só é possível excluir mensagens enviadas por este sistema e dentro do período permitido pelo WhatsApp (aprox. 48h).",
          ERR_MSG_NOT_EDITABLE: "Não foi possível editar a mensagem no WhatsApp. Só é possível editar mensagens enviadas por este sistema e dentro dos últimos 15 minutos.",
