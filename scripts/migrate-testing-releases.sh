#!/bin/bash
# Migra el auto-deploy de testing (pressticket) a release-based y activa el
# cambio de Telegram (quita el hotfix telegram-noreply que lo desactivaba).
#
...
echo "== 2) activar el cambio de Telegram (quitar hotfix del deploy) =="
...
echo "La auto-respuesta de Telegram queda ACTIVA (ya no se re-aplica el parche)."
